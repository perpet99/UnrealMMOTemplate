...
void AChatOnlineBeaconClient::Chat_CS_Implementation(const FString & chat)
{
	Chat_SC(chat);
}

bool AChatOnlineBeaconClient::Chat_CS_Validate(const FString & chat)
{
	return true;
}

void AChatOnlineBeaconClient::Chat_SC_Implementation(const FString & chat)
{
